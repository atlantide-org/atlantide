...
#: quadratically with the graph, and state JSON compresses by roughly 10x.
COMPRESS_OVER = 64 * 1024

#: gzip's magic number: a stored document is self-describing, so a reader never
#: has to trust a transport header to decode it.
